...
from tats import VQFinetune, VQGANDinoV2Action, VideoData, get_image_action_dataloader, count_parameters
...
def main():
    ...
    parser.add_argument('--action_activation', nargs='+', type=str, default=('none', 'none', 'none', 'none', 'none', 'none', 'none'),
