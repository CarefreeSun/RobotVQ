...
do
    ...
    do
        ...
        --n_stacked_clip 1 \
        --weight_path '/mnt/data-rundong/RobotVQ/1203-lr1e-6-8node-8v100-bs4-seqlen3-attn12-7actdec4-drop01-crop-kla-dim512-imagenetnorm-split-gan-continue-1202-no_split_gan-step14000/checkpoints/step_checkpoint-step_50000.ckpt' &
    done
done
