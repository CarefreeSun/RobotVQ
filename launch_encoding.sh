...
do
    ...
    do
        ...
        --n_stacked_clips 1 \
        --weight_path '/mnt/data-rundong/RobotVQ/1210-lr1e-6-8node-8v100-bs4-seqlen3-attn12-7actdec4-drop01-crop-kla-dim1024-imagenetnorm-imagegan-ganfeatloss02/checkpoints/step_checkpoint-step_20000.ckpt' &
    done
done
