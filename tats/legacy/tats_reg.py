...
# 2024.10.24
# copy from tats_moreactdeclayer, add KL regularization to codebook to avoid index collapse
...
class VQGANDinoV2Action(pl.LightningModule):
    ...
    def __init__(self, args):
        ...
        self.action_decoder_plus = ActionDecoderStack(args.embedding_dim, args.action_hidden_dim, args.action_dim, activations)
    ...
    def decode(self, encodings, encodings_action):
        ...
        action_decoded = self.action_decoder_plus(h_action) # B, T, embed_dim, 7
    ...
    def decode_action(self, encodings): # encodings: B, T, 7
        ...
        h = h.permute(0, 1, 3, 2)
        return self.action_decoder_plus(h)
    ...
    def configure_optimizers(self):
        ...
        opt_ae = torch.optim.Adam(list(self.encoder.parameters())+
                                  ...
                                  list(self.action_decoder_plus.parameters())+
...
class ActionDecoder(nn.Module):
    def __init__(self, embed_dim, hidden_dim, output_dim, activation=torch.tanh):
        super().__init__()
        self.fc1 = nn.Linear(embed_dim * output_dim, hidden_dim * 4)
        self.act1 = SiLU()
